...
const pages = [
  {pageTitle: "Home", pageNum: 1, pageDescription: "this is home page"},
...
const Page = ({pageTitle, pageNum, pageDescription}) => {
  return (
    <div>
    ...
    return(
      <>
        <Page 
          ...
          pageDescription={SelectedPage.pageDescription}></Page>
